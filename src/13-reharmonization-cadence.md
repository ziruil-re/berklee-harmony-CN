...
![三种功能类别示意](images/p043_score_1.png)
...
![原始和弦进行](images/p044_score_1.png)

![重配和声后的进行](images/p044_score_2.png)
...
![V7 的欺骗解决](images/p045_score_1.png)
...
![属终止式：V7 → I](images/p046_score_1.png)

### 下属终止式 (Subdominant Cadence)

![下属终止式：IV → I](images/p046_score_2.png)

### 完全终止式 (Full Cadence)

一个**下属 → 属 → 主**的进行被视为**完全终止式 (full cadence)**，因为调的三种功能类别全部得到了体现。传统的完全终止式为 **IV → V → I**：

![完全终止式：IV → V → I](images/p046_score_3.png)
...
![IV → V(sus4) → I](images/p047_score_1.png)

### IV → IV/属音根音 → I

更加含蓄的变体——从下属到属的转换仅涉及根音从 IV 到 V 的移动：

![IV → IV/属音根音 → I](images/p047_score_2.png)

### II-7 → V7 → I 终止式

II-7 → V7 → I 终止式非常有力，因为所有根音进行都是**下行纯五度**。这一完全终止式的特殊变体在当代音乐中极为常用，某些风格几乎完全依赖于它：

![II-7 → V7 → Imaj7（多种调性示例）](images/p047_score_3.png)
