...
![倍减音程示例](images/p022_score_1.png)

增音程再扩大半音变为**倍增音程 (double augmented)**：

![倍增音程示例](images/p022_score_2.png)
...
![音程转位示意](images/p023_score_1.png)
...
![大音程转位为小音程](images/p023_score_2.png)

3. **小音程转位后变为大音程**

![小音程转位为大音程](images/p023_score_3.png)

4. **纯音程转位后仍为纯音程**

![纯音程转位](images/p024_score_1.png)

5. **增音程转位后变为减音程**

![增音程转位为减音程](images/p024_score_2.png)

6. **减音程转位后变为增音程**

![减音程转位为增音程](images/p024_score_3.png)

7. **倍减音程转位后变为倍增音程**

![倍减转位为倍增](images/p024_score_4.png)

8. **倍增音程转位后变为倍减音程**

![倍增转位为倍减](images/p024_score_5.png)
